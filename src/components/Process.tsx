    ...
    <section id="process" className="section-padding bg-gray-50 relative overflow-hidden">
      ...
      <div className="container-wide relative">
        ...
        <div className="relative">
          ...
          <div className="overflow-x-auto pb-4 -mx-4 px-4 scrollbar-thin scrollbar-thumb-brand-orange/60 scrollbar-track-gray-200">
            <div className="flex min-w-max justify-center gap-4 lg:gap-6">
              {PROCESS.map((step, i) => {
                const Icon = getIcon(step.icon);
                return (
                  <div
                    key={`${step.title}-${i}`}
                    className="relative w-[220px] sm:w-[240px] lg:w-[220px] shrink-0 flex flex-col items-center text-center animate-on-scroll"
